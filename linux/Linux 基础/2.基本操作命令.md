...
1. 命令补全
   ...
   - Shell 自动补全
     ...
     Bash 通过 ReadLine ，参考命令的补全规范（compspec ）和 Readline 默认补全。

      [Letting Readline Type For You](https://www.gnu.org/software/bash/manual/bash.html#Commands-For-Completion) ， [Programmable Completion](https://www.gnu.org/software/bash/manual/bash.html#Programmable-Completion)
