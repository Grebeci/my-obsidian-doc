...
1. **命令补全**
   ...
   - Shell 自动补全
     ...
     参考： [Letting Readline Type For You](https://www.gnu.org/software/bash/manual/bash.html#Commands-For-Completion) ， [Programmable Completion](https://www.gnu.org/software/bash/manual/bash.html#Programmable-Completion)

     Bash 扩展 - 补全 [Bash-completion](https://github.com/scop/bash-completion/)
