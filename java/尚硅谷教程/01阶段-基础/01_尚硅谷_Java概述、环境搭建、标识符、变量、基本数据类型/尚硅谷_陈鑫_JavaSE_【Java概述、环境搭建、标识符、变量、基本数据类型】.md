...
* [x] 能够编写HelloWorld程序编译并执行（掌握）
* [x] 能够配置环境变量JAVA_HOME（会参照笔记配置）
* [x] 能够辨识关键字（掌握）
* [x] 理解标识符的含义（掌握）
* [x] 理解Java中的基本数据类型分类（掌握）
* [x] 能够定义8种基本数据集类型的变量（掌握）
...
![1561383524152](imgs/1561383524152.png)
...
![](imgs/下载4.jpg)
  ...
  * 下拉页面，找到 **Java SE Development Kit 8u202**，选择**Accept License Agreement**，如图所示：![](imgs/下载5.jpg)
